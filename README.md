...
- 💊 **Medications tab** — drug library with Arabic/English search, details (ingredients, indications, prescription status, approximate Nahdi price) and one-tap "add reminder"
...
- 💊 **تبويب الأدوية** — مكتبة أدوية ببحث عربي/إنجليزي، تفاصيل (المكونات، دواعي الاستخدام، الوصفة، سعر النهدي التقريبي) وزر إضافة تذكير مباشر
