...
- 💊 **Medications tab** — drug library with Arabic/English search, details (ingredients, indications, recommended dosage, method of use, prescription status, approximate Nahdi price with stock and usage lines) and one-tap "add reminder"
...
- 💊 **تبويب الأدوية** — مكتبة أدوية ببحث عربي/إنجليزي، تفاصيل (المكونات، دواعي الاستخدام، الجرعة الموصى بها، طريقة الاستخدام، الوصفة، سعر النهدي التقريبي مع التوفر وخطوط الاستخدام) وزر إضافة تذكير مباشر
